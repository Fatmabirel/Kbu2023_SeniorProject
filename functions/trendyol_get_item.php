...
<?php 
	...
	function get_products_TRENDYOL($conn, $key, $products_exist,$category){
		...
		$url2 = "https://www.trendyol.com/sr?q=". $key . '&qt=' .$key .'&st='. $key . '&os=1&pi=2';
		...
		$url3 = "https://www.trendyol.com/sr?q=". $key . '&qt=' .$key .'&st='. $key . '&os=1&pi=2';
